...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-grindzone-dark flex flex-col">
      <div className="flex-1">
        <div className="container mx-auto px-4 py-8 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <GrindZoneLogo size="large" />
              <h2 className="text-2xl md:text-4xl font-bold mt-6 text-grindzone-blue glow-text">
              ...
              <div className="mt-10 grid grid-cols-3 gap-8 text-center">
                <div>
                  <div className="text-3xl font-bold text-grindzone-blue glow-text">10K+</div>
                  <div className="text-sm text-gray-400">Players</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-grindzone-blue glow-text">500+</div>
                  <div className="text-sm text-gray-400">Tournaments</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-grindzone-blue glow-text">50+</div>
      ...
      <footer className="bg-grindzone-darker py-4 border-t border-border">
